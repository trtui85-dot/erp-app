...
async function migrate() {
  ...
  try {
    ...
    if (Number(prodCount.rows[0].c) === 0) {
      ...
      -- 🥬 الخضروات
      ('تماته', 'الربطة', 'fixed', 350, 20, 5, ${catMap['الخضروات'] || 1}),
      ('بومپتير', 'كيس', 'fixed', 250, 40, 21, ${catMap['الخضروات'] || 1}),
      ('لبصل', 'كيس', 'fixed', 200, 30, 14, ${catMap['الخضروات'] || 1}),
      ('كاروت', 'كيل', 'fixed', 300, 15, 10, ${catMap['الخضروات'] || 1}),
      ('برجيم', 'كيس', 'fixed', 320, 15, 5, ${catMap['الخضروات'] || 1}),
      ('امبطاص', 'كيل', 'fixed', 400, 10, 7, ${catMap['الخضروات'] || 1}),
      ('الديوك', 'كيس', 'fixed', 280, 15, 10, ${catMap['الخضروات'] || 1}),
      ('لخيار', 'كيس', 'fixed', 280, 20, 5, ${catMap['الخضروات'] || 1}),
      ('بافروه لخضر', 'بطة', 'fixed', 180, 20, 10, ${catMap['الخضروات'] || 1}),
      ('بافروه لحمر', 'بطة', 'fixed', 180, 20, 10, ${catMap['الخضروات'] || 1}),
      -- 🌾 الحبوب والمواد الجافة
      ('الأرز', 'كيس', 'fixed', 500, 50, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('وركل', 'كيس', 'fixed', 300, 30, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('القمح', 'كيس', 'fixed', 280, 40, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('الشعير', 'كيس', 'fixed', 250, 30, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('مارو', 'كيس', 'fixed', 200, 20, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('كسكس', 'كيس', 'fixed', 450, 25, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('دقتني', 'كيس', 'fixed', 300, 20, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('بصام المبلول', 'كيس', 'fixed', 350, 20, 30, ${catMap['الحبوب والمواد الجافة'] || 2}),
      ('بصام اليابس', 'كيس', 'fixed', 280, 20, 365, ${catMap['الحبوب والمواد الجافة'] || 2}),
      -- 🥛 الألبان والمشروبات
      ('البن', 'كيل', 'fixed', 2200, 10, 180, ${catMap['الألبان والمشروبات'] || 3}),
      ('الحليب', 'بوش', 'fixed', 350, 30, 7, ${catMap['الألبان والمشروبات'] || 3}),
      ('القشطة', 'بوش', 'fixed', 400, 20, 30, ${catMap['الألبان والمشروبات'] || 3}),
      ('لبن', 'بوش', 'fixed', 300, 25, 14, ${catMap['الألبان والمشروبات'] || 3}),
      ('العصير', 'بوش', 'fixed', 250, 30, 30, ${catMap['الألبان والمشروبات'] || 3}),
      -- 🧂 مواد الطبخ والتوابل
      ('الملح', 'كيل', 'fixed', 100, 20, 365, ${catMap['مواد الطبخ والتوابل'] || 4}),
      ('السكر', 'كيس', 'fixed', 400, 40, 365, ${catMap['مواد الطبخ والتوابل'] || 4}),
      ('الزيت', 'بشل', 'fixed', 600, 30, 180, ${catMap['مواد الطبخ والتوابل'] || 4}),
      ('الزعفران', 'كيل', 'fixed', 5000, 5, 365, ${catMap['مواد الطبخ والتوابل'] || 4}),
      ('الفلفل', 'كيل', 'fixed', 3000, 5, 365, ${catMap['مواد الطبخ والتوابل'] || 4}),
      ('الكمون', 'كيل', 'fixed', 2500, 5, 365, ${catMap['مواد الطبخ والتوابل'] || 4}),
      ('التوابل المشكلة', 'كيل', 'fixed', 3000, 5, 365, ${catMap['مواد الطبخ والتوابل'] || 4}),
      -- 🍪 مواد غذائية أخرى
      ('البسكويت', 'بكط', 'fixed', 350, 20, 90, ${catMap['مواد غذائية أخرى'] || 5}),
      ('المعكرونة', 'بكط', 'fixed', 350, 25, 365, ${catMap['مواد غذائية أخرى'] || 5}),
      ('الخبز', 'بطة', 'fixed', 150, 30, 3, ${catMap['مواد غذائية أخرى'] || 5}),
      ('الشاي', 'بكط', 'fixed', 1200, 10, 365, ${catMap['مواد غذائية أخرى'] || 5}),
      ('القهوة', 'كيل', 'fixed', 2200, 10, 180, ${catMap['مواد غذائية أخرى'] || 5}),
      ('المربى', 'بطة', 'fixed', 500, 15, 180, ${catMap['مواد غذائية أخرى'] || 5}),
      ('الشوكولاتة', 'بكط', 'fixed', 400, 20, 180, ${catMap['مواد غذائية أخرى'] || 5})
    `);
